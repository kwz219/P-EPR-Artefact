...
public class RunCombination {
    public static void main(String[] args){
        ...
        String output_dir="D:/文档/APR-Ensemble/Logs/nobugfeature";
        ...
        for(int ind=11;ind<12;ind++){
            ...
            for (int k=1;k<selected_tools.size()+1;k++){
                ...
                for (int rseed =1;rseed <2;rseed++) {
                    ...
                    launcher.configTools(selected_tools);
                    launcher.fixDefects4J(d4j_info.infos, "E:/APR/FL-VS-APR-master/FL-VS-APR-master/data/BuggyFiles", "select",
                            output_dir + "/" + "21" + "_" + String.valueOf(selected_tools.size()) + "_" + String.valueOf(0.5) + "_" + String.valueOf(k) + "_selectmode.json",
                            rseed, 0.5, all_log_file, k, new String[]{});
                }
